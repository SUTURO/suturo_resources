...
\end{figure}
	...
	The system runs with Ros-Kinetic. Instructions on how to install Ros can be found \href{http://wiki.ros.org/kinetic/Installation/Ubuntu}{here}. We recommended to install the Desktop-Full version.\\
