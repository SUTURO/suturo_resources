...
\begin{document}
	...
	\begin{navigation}
	Planning determines a goal for the \texttt{move base action}. In this goal the HSR is turned $90^\circ$ to the nearest table, allowing it to look over its shoulder having a clear view of the table without the arm in its way. The default navigation client of the HSR then executes the action. \end{navigation}
