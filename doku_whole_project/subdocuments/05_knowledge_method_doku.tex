...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{pictures/knowledge_placing_objects}
...
\begin{figure}
    ...
    %    \centering
        \includegraphics[width=0.8\textwidth]{pictures/knowledge_roles_gr}
        \caption{Roles in Grocery Storing}
        \label{fig:kn_ro_gr}
    %\end{minipage}\hfill
    %\begin{minipage}{0.45\textwidth}
    %    \centering
        \includegraphics[width=0.8\textwidth]{pictures/knowledge_roles_cl}
