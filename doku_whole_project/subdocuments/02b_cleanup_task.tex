...
\begin{document}
	...
	\chapter{Clean Up Task Overview}
		...
		\section{Goal}
		For Clean Up the HSR had to navigate a room in which objects are distributed. The goal position for the objects was given prior to the beginning of the task. The objects were located at previously unknown positions. The HSR had to be able to detect them in the room pick them up and transport them to the designated goal position. The HSR had to achieve the given tasks autonomously and manipulate objects like explained in the goal section of the Clean Up task chapter. It had 5 minutes to complete the task.
