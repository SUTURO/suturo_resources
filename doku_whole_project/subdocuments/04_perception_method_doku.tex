...
hsrb\_1ms stands for first milestone and is still in use.
...
was used by the \textit{PrimitiveShapeAnnotator}. Object shapes (cylinder, sphere, box) are used to determine which type of basic model is used to spawn it in the Planning and Knowledge world representation.
...
The outputs of the \textit{PrimitiveShapeAnnotator} and \textit{SuturoShapeAnnotator} are shown in the figures \ref{fig:shapeAnnotatorShelvePrimitive} and \ref{fig:shapeAnnotatorShelveSuturo}.
...
The graph \ref{fig:shapeAnnotatorShelveGraph} shows how long it takes to process one frame for each annotator.
\begin{figure}
  \center
  \includegraphics[width=1.2\textwidth]{pictures/perception/shape_annotator/classification_test_shelve/chart.png}
  \caption{Execution time}
  \label{fig:shapeAnnotatorShelveGraph}
\end{figure}
...
The outputs of the \textit{PrimitiveShapeAnnotator} and \textit{SuturoShapeAnnotator} are shown in the figures \ref{fig:shapeAnnotatorTablePrimitive} and \ref{fig:shapeAnnotatorTableSuturo}.

\begin{figure}
  \center
  \includegraphics[width=0.5\textwidth]{pictures/perception/shape_annotator/classification_test_table/primitive.png}
  \caption{PrimitiveShapeAnnotator}
  \label{fig:shapeAnnotatorTablePrimitive}
\end{figure}
\begin{figure}
  \center
  \includegraphics[width=0.5\textwidth]{pictures/perception/shape_annotator/classification_test_table/suturo.png}
  \caption{SuturoShapeAnnotator}
  \label{fig:shapeAnnotatorTableSuturo}
\end{figure}

The graph \ref{fig:shapeAnnotatorTableGraph} shows how long it takes to process one frame for each annotator.

\begin{figure}
 \center
  \includegraphics[width=1.2\textwidth]{pictures/perception/shape_annotator/classification_test_table/chart.png} 
  \caption{Execution time}
  \label{fig:shapeAnnotatorTableGraph}
\end{figure}
...
The outputs of the \textit{PrimitiveShapeAnnotator} and \textit{SuturoShapeAnnotator} are shown in the figures \ref{fig:shapeAnnotatorTrainingPrimitive} and \ref{fig:shapeAnnotatorTrainingSuturo}.

\begin{figure}
  \center
  \includegraphics[width=0.5\textwidth]{pictures/perception/shape_annotator/classification_test_training/primitive.png}
  \caption{PrimitiveShapeAnnotator}
  \label{fig:shapeAnnotatorTrainingPrimitive}
\end{figure}
\begin{figure}
  \center
  \includegraphics[width=0.5\textwidth]{pictures/perception/shape_annotator/classification_test_training/suturo.png}
  \caption{SuturoShapeAnnotator}
  \label{fig:shapeAnnotatorTrainingSuturo}
\end{figure}

The graph \ref{fig:shapeAnnotatorTrainingGraph} shows how long it takes to process one frame for each annotator.
\begin{figure}
  \center
  \includegraphics[width=1.2\textwidth]{pictures/perception/shape_annotator/classification_test_training/chart.png}
  \caption{Execution time}
  \label{fig:shapeAnnotatorTrainingGraph}
\end{figure}
