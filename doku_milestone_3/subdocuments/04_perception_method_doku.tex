...
\begin{itemize}
	...
	\item NormalEstimator : Estimates surface normals in a PointCloud 
	...
	\item ClusterColorHistogramCalculator : Calculates the individual color quantity in relation to all colors in the cluster   
	...
	\item CaffeAnnotator : Uses a Caffe neural network to perform feature extraction to prepare the input data for classification
