...
tmux send-keys -t "$SESSION:0.0" 'roslaunch suturo_bringup restaurant_mapping.launch' C-m
...
tmux send-keys -t "$SESSION:0.3" 'roslaunch suturo_bringup restaurant_mapping.launch' C-m
# Magic Number
sleep 2
...
tmux send-keys -t "$SESSION:1.1" 'nlp_venv && python3 nlp_gpsr.py -hsr' C-m
