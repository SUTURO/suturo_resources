...
tmux send-keys -t "$SESSION:1.0" 'hotfix' C-m
tmux send-keys -t "$SESSION:1.1" 'hotfix' C-m
tmux send-keys -t "$SESSION:1.2" 'hotfix' C-m
tmux send-keys -t "$SESSION:1.3" 'hotfix' C-m

tmux send-keys -t "$SESSION:1.0" 'virtual_nlp && run_rasa' C-m
tmux send-keys -t "$SESSION:1.1" 'nlp_venv && virtual_nlp && python3 nlp_mcrs.py -hsr' C-m
